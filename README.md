...
In JDWorld OS è cosi strutturato:
...
* jdwos-ytdlp-stm, installa yt-dlp e aggiunge 3 comandi nel menu(scarica immagine, video, musica), in piu abilita klipper alla cattura di MP4/MP3# JDWorld-OS
